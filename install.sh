#!/usr/bin/env sh
# Universal installer for logsift. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/logsift.git"
echo "Installing logsift ..."
