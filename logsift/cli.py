...
import argparse, sys
from logsift.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="logsift", description="LOGSIFT — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from logsift.mcp_server import serve
        return serve()
    if args.cmd == "scan":
