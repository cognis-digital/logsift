"""Native cognis-connect emit for logsift — forward findings to any platform.

Maps logsift's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    logsift ... --format json | logsift-emit --to stix
    logsift-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
