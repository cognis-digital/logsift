"""LOGSIFT core — Detect brute-force, spray, and anomalous auth events in logs."""
...
RULES = [
    ("LOG-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("LOG-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("LOG-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
